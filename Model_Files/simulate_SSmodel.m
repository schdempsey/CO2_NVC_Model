% simulate_SSmodel.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_SSmodel(tout,theta)
% [...] = simulate_SSmodel(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_SSmodel(...)
%
% INPUTS:
% =======
...
function varargout = simulate_SSmodel(varargin)
...
if(max(options_ami.sens_ind)>34)
...
sol = ami_SSmodel(tout,theta(1:34),kappa(1:8),options_ami,plist,xscale,init,data);
if(nargout>1)
