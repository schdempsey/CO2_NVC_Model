% simulate_H22.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_H22(tout,theta)
% [...] = simulate_H22(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_H22(...)
%
% INPUTS:
% =======
...
function varargout = simulate_H22(varargin)
...
if(max(options_ami.sens_ind)>37)
...
sol = ami_H22(tout,theta(1:37),kappa(1:19),options_ami,plist,xscale,init,data);
if(nargout>1)
