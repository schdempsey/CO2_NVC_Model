% simulate_Dyn_H22_A3.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_Dyn_H22_A3(tout,theta)
% [...] = simulate_Dyn_H22_A3(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_Dyn_H22_A3(...)
%
% INPUTS:
% =======
...
function varargout = simulate_Dyn_H22_A3(varargin)
...
if(max(options_ami.sens_ind)>45)
...
sol = ami_Dyn_H22_A3(tout,theta(1:45),kappa(1:25),options_ami,plist,xscale,init,data);
if(nargout>1)
