% simulate_SSM_H22_A3.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_SSM_H22_A3(tout,theta)
% [...] = simulate_SSM_H22_A3(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_SSM_H22_A3(...)
%
% INPUTS:
% =======
...
function varargout = simulate_SSM_H22_A3(varargin)
...
if(max(options_ami.sens_ind)>40)
...
sol = ami_SSM_H22_A3(tout,theta(1:40),kappa(1:9),options_ami,plist,xscale,init,data);
if(nargout>1)
