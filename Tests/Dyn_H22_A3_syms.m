...
model.sym.p = [k_u1, k_u2, k_u3, kPF1, kPF2, kIN, kIN2, kINF, kINF2, sinkN_NO, sinkN_NPY, sinkN_Pyr, sinkCa_NO, sinkCa_NPY, sinkCa_Pyr, kPL, kCOX, kPGE2, sinkPGE2, kNOS, kNO, sinkNO, kNPY, Vmax, Km, sinkNPY, ky1, ky2, ky3, K1, K2, K3, vis1, vis2, vis3, kscalemet, Km2, kCO2, Dng, Dgc, kCx26g, sinkATP, kATP, kCx261, kCx262];
%%  
...
G=(NOvsm-NOvsm0) +(PGE2vsm-PGE2vsm0) -(NPYvsm-NPYvsm0); 
